...
export const saveCard = (cardData: Omit<Card, 'id' | 'createdAt' | 'learned'>): Card => {
...
export const updateCard = (id: string, updatedFields: Partial<Omit<Card, 'id' | 'createdAt'>>): Card | null => {
  const cards = getCards();
